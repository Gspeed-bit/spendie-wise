...
const Footer = () => {
  ...
  return (
    <footer className="bg-white   lg:mx-auto dark:bg-gray-900">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <p className="mt-6 max-w-md text-center leading-relaxed text-gray-500 sm:max-w-xs sm:text-left dark:text-gray-400">
              ...
              Empowering You to Make Informed Decisions, Save Smarter, and Live
              Better. Let's Navigate Your Financial Journey Together!
            </p>
