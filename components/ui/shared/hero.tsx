      ...
      <div className="mx-auto max-w-screen px-4 py-32 lg:flex lg:h-screen lg:items-center">
        <div className="mx-auto max-w-4xl text-center space-y-6">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            ...
            <a
              className="block w-full rounded border border-primary-300 px-12 py-3 text-sm font-medium text-primary hover:bg-primary-600 focus:outline-none focus:ring active:bg-blue-500 sm:w-auto"
              href="#"
            >
              Learn More
            </a>
